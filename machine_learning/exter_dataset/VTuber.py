...
def get_data():
    paths = [
    "ban_events.parquet",
    "chats_2021-03.parquet",
    "chats_2021-04.parquet",
    "chats_2021-05.parquet",
    "chats_2021-06.parquet",
    "chats_2021-07.parquet",
    "chats_2021-08.parquet",
    "chats_2021-09.parquet",
    "chats_2021-10.parquet",
    "chats_2021-11.parquet",
    "chats_2021-12.parquet",
    ...
    "superchats_2021-03.parquet",
    "superchats_2021-04.parquet",
    "superchats_2021-05.parquet",
    "superchats_2021-06.parquet",
    "superchats_2021-07.parquet",
    "superchats_2021-08.parquet",
    "superchats_2021-09.parquet",
    "superchats_2021-10.parquet",
    "superchats_2021-11.parquet",
    "superchats_2021-12.parquet",
    "superchats_2022-01.parquet",
    "superchats_2022-02.parquet",
    "superchats_2022-03.parquet",
    "superchats_2022-04.parquet",
    "superchats_2022-05.parquet",
    ]
