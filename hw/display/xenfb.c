...
#define BLT(SRC_T, DST_T, RSB, GSB, BSB, RDB, GDB, BDB)                                                              \
    ...
    {                                                                                                                \
        SRC_T *src = (SRC_T *)(xenfb->pixels + xenfb->offset + (line * xenfb->row_stride) + (x * xenfb->depth / 8)); \
        DST_T *dst = (DST_T *)(data + (line * linesize) + (x * bpp / 8));                                            \
        int col;                                                                                                     \
...
static void xenfb_update(void *opaque)
{
    ...
    if (xenfb->do_resize)
    {
        ...
        case 32:
            ...
            surface = qemu_create_displaysurface_from(xenfb->width, xenfb->height, format,
